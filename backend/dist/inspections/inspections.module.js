...
exports.InspectionsModule = InspectionsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: inspection_schema_1.Inspection.name, schema: inspection_schema_1.InspectionSchema }]),
        ],
        controllers: [inspections_controller_1.InspectionsController],
        providers: [inspections_service_1.InspectionsService],
        exports: [inspections_service_1.InspectionsService, mongoose_1.MongooseModule],
    })
], InspectionsModule);
